...
- **📊 Dynamic Scoring**: 0-100% relevance score representing the percentage of matching ingredients relative to the user's input, optimized by an 80% coverage ratio.
